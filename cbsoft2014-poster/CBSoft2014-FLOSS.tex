...
between 2001 and 2010, and 30 FEES papers from 2008 to 2010
          	\item Matchers: software(s) livre(s), ferramenta(s) livre(s), ferramenta(s) aberta(s), software(s) aberto(s), código aberto, repositório(s) de software, free software, open source, open software, libre software, software repository, OSS, FLOSS, FOSS, and OSSD
		\end{itemize}
